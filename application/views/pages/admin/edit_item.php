					...
					<div class="row">
						<div class="col-md-5 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />									
                                        <?=form_open(base_url()."update_item",array('class' => 'form-horizontal form-label-left'));?>
										...
										<div class="item form-group">
											...
											<div class="col-md-9 col-sm-9 ">
												<input type="text" id="first-name" required="required" class="form-control" name="code" value="<?=$item['code'];?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-9 col-sm-9 ">
												<input type="text" id="last-name" required="required" class="form-control" name="item_name" value="<?=$item['name'];?>">
											</div>
										</div>
										<div class="item form-group">
                                        ...
                                        <?php
                                        if($item['category']=="rubber"){
                                            $desc="Synthetic Rubber Paint";
                                        }else if($item['category']=="corrosive"){
                                            $desc="Anti-Corrosive Paint";
                                        }else if($item['category']=="special"){
                                            $desc="Special Home Paint";
                                        }else{
                                            $desc=ucfirst($item['category'])." Paint";
                                        }
                                        ?>
										<div class="item form-group">
											...
											<div class="col-md-9 col-sm-9 ">
												<select name="category" class="form-control" required>
                                                    <option value="<?=$item['category'];?>"><?=$desc;?></option>
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-9 col-sm-9 ">
												<input type="text" id="last-name" required="required" class="form-control" name="price" value="<?=$item['price'];?>">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-9 col-sm-9 ">
												<input type="text" id="last-name" required="required" class="form-control" name="quantity" value="<?=$item['quantity'];?>">
											</div>
										</div>
